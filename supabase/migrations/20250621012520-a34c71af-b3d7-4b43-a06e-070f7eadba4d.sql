...
-- First, clean up duplicate and conflicting RLS policies on the notes table
...
-- Add enhanced content validation function
...
-- Create policy for shared notes (public read access but with expiry check)
