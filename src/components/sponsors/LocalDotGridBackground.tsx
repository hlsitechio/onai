...
const LocalDotGridBackground: React.FC = () => {
  return (
      ...
      <div className="absolute inset-0">
        ...
        >
          <defs>
            ...
            <radialGradient id="localGlow" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
          ...
          <rect width="100%" height="100%" fill="url(#localDotGrid)" />
          <rect width="100%" height="100%" fill="url(#localDotGridLarge)" />
          
          {/* Central glow effect */}
          <rect width="100%" height="100%" fill="url(#localGlow)" />
        </motion.svg>
      </div>
...
export default LocalDotGridBackground;
