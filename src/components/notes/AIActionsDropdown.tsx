...
const AIActionsDropdown: React.FC<AIActionsDropdownProps> = ({ 
  ...
  return (
    <div className="relative">
      ...
      {/* AI Actions Panel */}
      {isOpen && (
        <div className="absolute top-full right-0 mt-2 w-80 lg:w-96 glass-panel-dark rounded-xl overflow-hidden flex flex-col shadow-[0_8px_30px_rgb(0,0,0,0.4)] border border-white/5 z-50">
          <div className="p-3 border-b border-white/5 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Sparkles className="h-5 w-5 text-noteflow-400" />
              <h3 className="text-white font-medium text-sm">Gemini 2.5 Flash AI</h3>
            </div>
            <div className="flex items-center gap-2">
              <Button 
                variant="ghost" 
          ...
          <div className="p-4 flex flex-col gap-4 max-h-96 overflow-y-auto">
            ...
            <div className="flex gap-2">
              <Button 
                ...
                className="bg-noteflow-500 hover:bg-noteflow-600 text-white flex-1 text-xs"
                size="sm"
              >
              ...
              <div className="mt-4">
                ...
                <div className="relative">
                  <Textarea 
                    ...
                    className={cn(
                      "h-32 resize-none bg-black/30 border-white/10 text-white text-xs",
