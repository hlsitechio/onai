  ...
  return (
    <div className="space-y-3 border-t border-white/10 pt-3">
      ...
      <div className="space-y-2">
        <div 
          className="border-2 border-dashed border-white/20 rounded-lg p-4 text-center cursor-pointer hover:border-noteflow-400/50 transition-colors"
        ...
        >
          {imagePreview ? (
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-slate-300">{selectedImage?.name}</p>
              <Button
                variant="ghost"
                size="sm"
                onClick={(e) => {
            ...
            <div className="space-y-2">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Or paste with Ctrl+V</p>
              </div>
            </div>
          )}
        </div>
      ...
      {selectedImage && (
        <Button
          ...
          className="w-full bg-noteflow-500 hover:bg-noteflow-600 text-white h-8 text-xs"
        >
          {isProcessing ? (
            <>
      ...
      {extractedText && (
        <div className="space-y-2">
          <h5 className="text-xs font-medium text-white">Extracted Text:</h5>
          <Textarea
            value={extractedText}
            onChange={(e) => setExtractedText(e.target.value)}
            className="h-24 bg-black/30 border-white/10 text-white resize-none text-xs"
