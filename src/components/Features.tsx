...
const Features = () => {
  ...
  return <section className="py-16 px-4 bg-black/95">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => <div key={index} className="bg-black/40 backdrop-blur-lg p-6 rounded-lg border border-white/10 hover:border-noteflow-400/50 transition-all hover:shadow-[0_0_15px_rgba(14,165,233,0.15)]">
