...
const ResizableHandle = ({
  ...
  <ResizablePrimitive.PanelResizeHandle
    className={cn(
      "relative flex w-2 items-center justify-center bg-white/5 hover:bg-white/10 transition-all duration-200 cursor-col-resize",
  ...
  >
    {withHandle && (
      <div className="z-10 flex h-6 w-4 items-center justify-center rounded-sm bg-white/10 hover:bg-white/20 transition-colors border border-white/20">
